    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <Link to="/" className="flex items-center justify-center gap-2.5 mb-10">
          ...
          <span className="text-xl font-semibold text-text">AviLegal</span>
        </Link>
        ...
        <div className="card">
          <div className="text-center mb-6">
            ...
            <p className="text-text-muted text-sm">Start your business registration today</p>
          </div>
        ...
        <p className="text-center text-text-muted text-xs mt-8">© 2024 AviLegal. All rights reserved.</p>
      </div>
    </div>
  )
}
